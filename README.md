...
2. **Searches** today's news via Claude with web search across World & Politics, India, Tech & AI, Business & Finance, Science & Health, Sports, Explore, and Deep Dive (podcasts & long reads) — pulling only from a curated list of trusted outlets per section
3. **Synthesises** stories — cross-referencing across outlets, flagging subscriber sources
4. **Narrates** the brief via Deepgram Aura in your chosen voice, producing an MP3
...
- A structured HTML brief with weather, stories across 6 news sections (World & Politics, India, Tech & AI, Business & Finance, Science & Health, Sports), an Explore section, and a Deep Dive section
- An MP3 audio narration of the four news sections and the Explore segment (Deep Dive is email-only)
